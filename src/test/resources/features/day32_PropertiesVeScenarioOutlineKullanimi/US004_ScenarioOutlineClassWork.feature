...
Feature: US004 DataTables Testi
  ...
  Scenario Outline: Test01 DataTables Veri Girisi
    ...
    And kullanici 2 saniye bekler
    And kullanici search bölumune "<firstname>" bilgisini girer
    And kullanici 2 saniye bekler
    And kullanici "<firstname>" ile basarili giris yaptigini dogrular
    And kullanici 2 saniye bekler
    And sayfayi kapatir
    Examples:
